...
public class Customer_Dashboard extends AppCompatActivity implements TrainRVAdapter.TrainClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        @SuppressLint("MissingInflatedId") FloatingActionButton addFAB = findViewById(R.id.idAddFAB);
        ...
        //addFAB.setOnClickListener(view -> startActivity(new Intent(Customer_Dashboard.this, Add_Train.class)));
        getAllTrains();
    }
    ...
    private void displayBottomSheet (TrainRVModel trainRVModel){
        ...
        Button bookBtn = layout.findViewById(R.id.idBtnBookTrain);
        ...
        bookBtn.setOnClickListener(v -> {
            Intent i = new Intent(Customer_Dashboard.this, Book_Train.class);
    ...
    public boolean onOptionsItemSelected (@NonNull MenuItem item){
        ...
        if (id == R.id.idLogOut) {
            ...
            mAuth.signOut();
            startActivity(new Intent(Customer_Dashboard.this, MainActivity.class));
            this.finish();
            return true;
        }
