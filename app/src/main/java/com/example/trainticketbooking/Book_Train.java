...
import static com.example.trainticketbooking.R.layout.*;
...
public class Book_Train extends AppCompatActivity implements PaymentResultListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(activity_book_train);
...
//Displays the price of each seat in the present bus
        String price=trainRVModel.getPrice();
...
//Runs if no seats selected
                    Toast.makeText(Book_Train.this, "Select a minimum of 1 seat to pay", Toast.LENGTH_SHORT).show();
                } else{
//Runs if seats are selected
                    Toast.makeText(Book_Train.this, "Redirecting...", Toast.LENGTH_SHORT).show();
...
//        builder.show();
        ...
        Intent intent = new Intent(Book_Train.this, Ticket.class);
        intent.putExtra("TrainID", trainRVModel.getTrainID());
        intent.putExtra("Source",  trainRVModel.getSrc());
        intent.putExtra("Destination",  trainRVModel.getDest());
        intent.putExtra("Timings",  trainRVModel.getTimings());
...
//Updating value of available seats in Database
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Book_Train.this, "All seats booked", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onPaymentError(int i, String s) {
        ...
        Toast.makeText(Book_Train.this, "Try again", Toast.LENGTH_SHORT).show();
    }

    //Method to change the default action of Back button
    @Override
    public void onBackPressed(){
        startActivity(new Intent(Book_Train.this,Customer_Dashboard.class));
    }
}